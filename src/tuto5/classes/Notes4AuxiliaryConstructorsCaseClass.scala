...
object Notes4AuxiliaryConstructorsCaseClass {
  //les constructeurs auxiliaires d'un case classe sont differents aux constructeurs d'un classe ordinaire
  ...
  case class Animal(var name : String, var age : Int ){ //si on ne met pas var devant l'attribut  dans case class il le considère comme val
  ...
  object Animal{
   ...
   //le compilateur va generer la methode apply du constructeur primaire => on n'a pas besoin de faire la méthode apply avec deux parametres ici
  ...
  def main(args: Array[String]): Unit = {
    ...
    var animal0 =  new Animal("MINOUCHA" , 8)
