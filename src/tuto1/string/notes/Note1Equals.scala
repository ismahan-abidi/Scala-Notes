...
object Note1Equals {
  def main(args: Array[String]): Unit = {
    ...
    val s4 = null
    //println(s3.toUpperCase == s4.toUpperCase)// value toUpperCase is not a member of Null
    val a = "Ismahan"
    val b = "ismahan"
    println(a.equalsIgnoreCase(b))
    //pour crer un String multiline il suffit de l'entourer par 3 double cotes
    val foo = """This is
       a multiline
       String"""
    println(foo)
    //on remarqu eque l'espace blanc au debut de chaque ligne est pris en compte
    ...
    """je suis
      ...
      |enervée""".stripMargin
    println(str)
    //pour annuler le retour a la ligne et le remplacer par un espace on utulise replaceALL("\n" , " ")
